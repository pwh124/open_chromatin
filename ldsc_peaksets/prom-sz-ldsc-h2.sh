#!/bin/sh
#SBATCH --job-name=prom_sumstat-h2
...
outdir=prom_${sumstat%.sumstats.gz}
echo $outdir
...
$LDSCdir/ldsc.py \
--h2 sumstats/$sumstat \
--ref-ld-chr prom/${line}.,roadmap_control/Roadmap.control.,baseline_v1.1/baseline. \
--out results/$outdir/${line} \
--overlap-annot  \
--frqfile-chr 1000G_Phase3_frq/1000G.EUR.QC. \
--w-ld-chr 1000G_Phase3_weights_hm3_no_MHC/weights.hm3_noMHC. \
--print-coefficients;
done < prom_annotations.txt
