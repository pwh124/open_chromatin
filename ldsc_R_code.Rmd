...
pdf(file = file.path(wd,"Figure.S2-pgc.09202018.pdf"),width = 8,height = 5)
pgc.sz
dev.off()
```
...
pdf(file = file.path(wd,"Figure.S3A_immune.09202018.pdf"),width = 12,height = 4.5)
immune.p
dev.off()
```
...
pdf(file = file.path(wd,"Figure.2A-psych.09202018.pdf"),width = 12,height = 4.5)
psych.p
dev.off()
```
...
pdf(file = file.path(wd,"Figure.2C-neuro_09202018.pdf"),width = 12,height = 4.5)
neuro.p
dev.off()
```
...
pdf(file = file.path(wd,"Figure.2B-behavioral_09202018.pdf"),width = 12,height = 4.5)
behave.p
dev.off()
```
...
pdf(file = file.path(wd,"Figure.S3B-additional_09202018.pdf"),width = 12,height = 4.5)
add.p
dev.off()
```
