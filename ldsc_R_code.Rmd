...
## Script was modified to read from GitHub repository
...
## The fully formatted results now need to be written out in a presentable way that can be a supplemental table.
```{r write_out}
...
## Now I want to plot some results!
```{r making some plots}
...
## Plotting the results from LDSC-SEG run on the CLOZUK schizophrenia GWAS
```{r plotting-clozuk}
...
## Plotting LDSC-SEG results from PGC schizophrenia GWAS.
```{r making pgc ldsc-seg plot}
...
## Plotting all the LDSC-SEG results from immune GWAS 
```{r}
#Immune related
...
## Plotting all the LDSC-SEG results from neuropsychiatric GWAS
```{r}
...
## Plotting all the LDSC-SEG results from neurological GWAS
```{r}
#neurological
...
## Plotting all the LDSC-SEG results from behavorial GWAS
```{r}
#behavioral
...
## Plotting all the LDSC-SEG results from additonally analyzed GWAS
```{r}
#additional
