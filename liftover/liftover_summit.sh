...
OUT_PATH=$HOME/data/PWH/public_atac_data/atac-data/liftover/hg19_summits_lift/filter_2
...
$mapper_path/bnMapper.py -fBED12 $BED $CHAIN_PATH/mm10.hg19.rbest.chain.gz -o $OUT_PATH/hg19_${BED}
